...
covid19 %>% 
  ...
  scale_x_date(date_breaks = "1 month",
   ...
   theme(legend.title = element_blank(),
        ...
        panel.grid.major.x = element_line(color = "gray70"),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank()) -> covid_sit
...
number_of_passengers %>%
  ...
  theme(legend.title = element_blank(),
        ...
        panel.grid.major.x = element_line(color = "gray70"),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank()) -> travelers_0708
...
number_of_passengers %>%
  ...
  labs(title = "Number of Passengers <b style='color:#970111'>2019</b> vs. <span style='color:#004e8f;'>2020</span>", 
   ...
   theme(legend.title = element_blank(),
        ...
        panel.grid.major.x = element_line(color = "gray70"),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank()) -> travelers_1920
...
unrate_large %>% 
  ...
  theme(legend.title = element_blank(),
        ...
        panel.grid.major.x = element_line(color = "gray70"),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank()) -> unemployment_0820
